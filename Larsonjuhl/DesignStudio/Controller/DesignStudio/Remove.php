...
class Remove extends \Magento\Framework\App\Action\Action { 
    ...
    public function execute() { 
            ...
            return $resultRedirect;
                ...
                $successMessage = $this->helper->removeSuccessMessage(); 
                ...
                try {
                    ...
                    if($quoteId)
                    {
                        $responsedata = $this->helper->removeArtwork($quoteId);        
                        if(isset($responsedata['isSuccess']) && $responsedata['isSuccess'])
                        { 
                            $_SESSION['artworkremovesuccess'] =$successMessage;
                        }
                        else
                        {  
                            $_SESSION['artworkremoveerror'] = $errorMessage;
                        }
                    }
                    else
                    {  
